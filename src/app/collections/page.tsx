                    ...
                    <div>
                        <div className="p-8 mx-auto max-w-7xl">
                            ...
                            <div className="flex justify-between items-center mb-4">
                                <h1 className="text-3xl text-theme-text font-semibold tracking">Document
                                    Collections</h1>
                            </div>
                        ...
                        <div className={"max-w-full bg-primary-900"}>
                            <div className="mx-auto max-w-7xl p-8">
                                ...
                                <p className="text-theme-bg opacity-90 pb-4 text-base tracking-wide">
                                    Easily upload and store multiple documents in a collection for streamlined
                                    processing. Once uploaded, your documents will be automatically parsed into
                                    structured data, enabling advanced functionalities such as searching, filtering, and
                                    exporting. Additionally, the processed data will be available for seamless
                                    integration into the GST pipeline.
                                </p>
                                <p className="text-theme-bg opacity-90 pb-4 text-base tracking-wide">
                                    Ensure your documents are in one of the supported formats for optimal processing.
                                    Supported File Formats&mdash;PDFs, JPEGs, PNGs, and TIFFs.
