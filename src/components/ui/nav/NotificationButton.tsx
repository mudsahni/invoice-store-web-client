...
export const NotificationButton: React.FC<NotificationButtonProps> = ({mobile}) => {
    const mobileButtonClasses = "relative ml-auto shrink-0 rounded-full bg-neutral-100 p-1 " +
        "text-neutral-800 hover:text-neutral-900 focus:outline-none focus:ring-1 focus:ring-neutral-900 focus:ring-offset-1 " +
        "focus:ring-offset-neutral-900 hover:bg-neutral-200"
    const webButtonClasses = "relative shrink-0 rounded-full bg-neutral-100 p-1 text-neutral-800 hover:text-neutral-900 hover:bg-neutral-200 " +
